...
def crop_edge_area_by_rectangle(image, color_range=None, alpha_range=None, is_run_crop=True):
    """
    对于rgba图像获取 alpha 的非零区域
    对于rgb图像，获取非零或者255的区域
    :param image: PIL.ImageFile.ImageFile
    :param color_range: 剪切边界的颜色区域，前开，后闭
    :param alpha_range: 剪切边界透明区域，前开后闭
